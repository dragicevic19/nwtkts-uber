...
export class AutocompleteComponent implements OnDestroy {
  @Output()
  locationChange: EventEmitter<PlaceSuggestion> =
    new EventEmitter<PlaceSuggestion>();

  private GEOAPIFY_API_KEY: String = 'b293cff4266e42dc8e383de20069faf9';

  searchOptions: Subject<PlaceSuggestion[] | null> = new Subject<
  ...
  private generateSuggestions(text: string) {
    const url = `https://api.geoapify.com/v1/geocode/autocomplete?text=${text}&limit=5&apiKey=${this.GEOAPIFY_API_KEY}`;
