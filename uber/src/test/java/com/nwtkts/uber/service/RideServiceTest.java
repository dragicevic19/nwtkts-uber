...
public class RideServiceTest {
    ...
    private Client makeClient() {
        ...
        return new Client(u, null, null, null, 10., null);
    }
    ...
    private RideRequest makeRideRequest(boolean pets, boolean babies) {
        ...
        return new RideRequest(routeDTO, vehicleType, pets, babies, List.of(), 3.6, 3.6, null, Arrays.asList("Bele njive 24, Novi Sad", "Promenada, Novi Sad"));
    }

    private Ride makeRideForClient(Client client, RideRequest rideRequest) {
        Ride ride = new Ride(rideRequest, 1.3, rideRequest.getVehicleType());
        ride.setClientsInfo(new HashSet<>(List.of(new ClientRide(client))));
        return ride;
    }
    ...
    public void setUp() {
        client = makeClient();
        rideRequest = makeRideRequest(false, false);
        ride = makeRideForClient(client, rideRequest);
    }
